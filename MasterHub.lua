...
spawn(function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : https://discord.gg/GjaPwZrc <Color=/>"):Display()
...
local Window = OrionLib:MakeWindow({Name = "Kaitun[Night-Hub]", HidePremium = false,IntroText = "Night-Hub Library", SaveConfig = true, ConfigFolder = "ConfigSave"})
...
task.spawn(function()
    ...
    C:AddParagraph("Kaitun/Cuttay","By LMNGAMING create, is Beta Version now! discord me so funny")

    C:AddToggle({
        Name = "Start Kaitun/Cuttay",
        Default = true,
        Callback = function(Value)
            _G.AutoFarm = Value
            _G.Farmfast = Value
            ...
            _G.AutoNextSea = Value
            StopTween(_G.AutoFarm)
            StopTween(_G.Farmfast)
            StopTween(_G.AutoNextSea)
        end    
    })
            ...
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.Farmfast and StardMag then
                        if (v.Name == "Shanda [Lv. 475]") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoNextSea and World1 then
...
spawn(function()
    ...
    pcall(function()
     ...
     until v.Humanoid.Health <= 0 or not v.Parent or not _G.AutoNextSea
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoNextSea and World2 then
                if game.Players.LocalPlayer.Data.Level.Value >= 700 then
                    _G.AutoFarm = true
...
spawn(function()
    ...
    _G.Farmfast = false
     ...
     sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius",math.huge)
     until _G.AutoNextSea == false or v.Humanoid.Health <= 0 or not v.Parent
     end
     end
   ...
   spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoNextSea and World3 then
...
local Section = C:AddSection({
	Name = "Weapon Kaitun Menu"
})



local SaberBoss = C:AddLabel("Boss Saber : ")
spawn(function()
    while wait() do
        ...
        pcall(function()
            ...
            elseif not game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Saber Expert [Lv. 200] [Boss]") then
...
local Jeremy = C:AddLabel("Jeremy Boss : ")

spawn(function()
    while wait() do
        if _G.AutoBartilo then
        pcall(function()
            if game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") then
                Jeremy:Set("Boss Jeremy : ✅ Spawn")
                _G.AutoBartilo = true
                _G.AutoFarm = false
            else
                if not game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("ReplicatedStorage"):FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Jeremy [Lv. 850] [Boss]") then
                Jeremy:Set("Boss Jeremy : ❌ Not Spawn")
    ...
    while wait(.1) do
        if _G.LockLevel then
            if game.Players.localPlayer.Data.Level.Value >= LockLevelValue then
                game.Players.localPlayer:Kick("Đúng Level mày Lock rồi,tao Kick mày đó ku!")
            end
        end
    end
end)
...
spawn(function()
    ...
    OrionLib:MakeNotification({
        Name = "Kaitun!",
        Content = "Loadding Script Complete",
